...
function CarouselTrending({ movies }) {
  const [isHovered, setIsHovered] = useState(false);
  const genre = "Trending"; // Static genre for the trending carousel
  ...
  return (
    <>
      <div
        className="w-full h-auto relative mb-[-120px]"
            ...
            <div className="flex  py-5 w-full scale-80">
              {movies.map((movie, index) => (
                <div
                  ...
                  className={`${
                    index === 8 ? "mr-30" : "mr-10"
                  } relative w-[306px] flex justify-center items-center`}
                >
                  <MovieCard movie={movie} genre={genre} variant="trending" />
                  <div
                    className={`${
                      index === 9
                        ? "left-[-180px]"
                        ...
                        ? "left-[-40px]"
                        : "left-[-60px]"
                    } text-white text-left  absolute z-0 top-[-50px] `}
                  >
                    <span
                      className="font-bold text-[#951a4f] text-[300px] text-stroke-white "
